...
public class DisplayContacts extends AppCompatActivity implements ContactListAdaptor.ContactItemInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseHandler(DisplayContacts.this);
    ...
    public void editOptionSelected(final String phoneNumber, String name) {
        final AlertDialog.Builder builder = new AlertDialog.Builder(DisplayContacts.this);

        LayoutInflater inflater = DisplayContacts.this.getLayoutInflater();
        final ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.activity_edit_contacts, null);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (checkPhone() & checkName() && isCheckContactExist(alertDialog)) {
                    ...
                    Toast.makeText(DisplayContacts.this, "Contact Updated", Toast.LENGTH_SHORT).show();
                    updateListView();
                    alertDialog.dismiss();
                }
            }
        ...
        builder.setTitle("Delete")
                ...
                .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(DisplayContacts.this, "Contact Deleted", Toast.LENGTH_SHORT).show();
                        db = new DatabaseHandler(DisplayContacts.this);
    ...
    public void search(String keyword) {
        ...
        if (cursor.getCount() == 0) {
            ...
            contactListAdaptor.clear();
            contactList.add(contact);
            contactListAdaptor = new ContactListAdaptor(DisplayContacts.this, contactList, null);
            listView.setAdapter(contactListAdaptor);
        } else {
            contactListAdaptor.clear();
            while (cursor.moveToNext()) {
            ...
            contactListAdaptor = new ContactListAdaptor(DisplayContacts.this, contactList, DisplayContacts.this);
            listView.setAdapter(contactListAdaptor);
        }
    }
}